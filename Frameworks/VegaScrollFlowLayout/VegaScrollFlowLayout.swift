...
open class VegaScrollFlowLayout: UICollectionViewFlowLayout, NSCopying
{
    ...
    {
        if let o = dynamicAnimator.layoutAttributesForCell(at: indexPath)?.copy() as? UICollectionViewLayoutAttributes
        {
            return o
        }
        
        UIDynamicAnimator(collectionViewLayout: self).layoutAttributesForCell(at: indexPath)
        
        return UIDynamicAnimator(collectionViewLayout: self).layoutAttributesForCell(at: indexPath)?.copy() as? UICollectionViewLayoutAttributes
    }
